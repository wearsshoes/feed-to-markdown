...
**Published Date:** 2024-05-16T18:35:53+00:00
...
`;
        ...
        expect(date).toBe('2024-05-16T18:35:53+00:00');
...
describe('Atom Feed Tests', () => {
    test('Process Atom feed', async () => {
        ...
        const expectedMarkdown = `
# New Feature Alert: Access Archived Webpages Directly Through Google Search **Link:** https://blog.archive.org/2024/09/11/new-feature-alert-access-archived-webpages-directly-through-google-search/ **Description:** In a significant step forward for digital preservation, Google Search is now making it easier than ever to access the past. Starting today, users everywhere can view archived versions of \\[…\\] **Author:** Chris Freeland **Published Date:** 2024-09-11T12:23:41Z **Content:** [![](http://blog.archive.org/wp-content/uploads/2024/02/wayback_logo-1024x453.jpg)](http://blog.archive.org/wp-content/uploads/2024/02/wayback_logo-scaled.jpg) In a significant step forward for digital preservation, Google Search is now making it easier than ever to access the past. Starting today, users everywhere can view archived versions of webpages directly through Google Search, with a simple link to the Internet Archive’s [Wayback Machine](https://web.archive.org/). **How It Works** ---------------- To access this new feature, conduct a search on [Google](https://www.google.com/) as usual. Next to each search result, you’ll find three dots—clicking on these will bring up the “About this Result” panel. Within this panel, select “More About This Page” to reveal a link to the Wayback Machine page for that website. Through this direct link, you’ll be able to view previous versions of a webpage via the Wayback Machine, offering a snapshot of how it appeared at different points in time. **A Commitment to Preservation** -------------------------------- At the Internet Archive, our mission is to provide, “Universal Access to All Knowledge.” The Wayback Machine, one of our best-known services, provides access to billions of archived webpages, ensuring that the digital record remains accessible for future generations. As Mark Graham, director of the Wayback Machine, explains: > “The web is aging, and with it, countless URLs now lead to digital ghosts. Businesses fold, governments shift, disasters strike, and content management systems evolve—all erasing swaths of online history. Sometimes, creators themselves hit delete, or bow to political pressure. Enter the Internet Archive’s Wayback Machine: for more than 25 years, it’s been preserving snapshots of the public web. This digital time capsule transforms our “now-only” browsing into a journey through internet history. And now, it’s just a click away from Google search results, opening a portal to a fuller, richer web—one that remembers what others have forgotten.” This collaboration with Google underscores the importance of web archiving and expands the reach of the Wayback Machine, making it even easier for users to access and explore archived content. However, the link to archived webpages will not be available in instances where the rights holder has opted out of having their site archived or if the webpage violates content policies. For more information about the **Wayback Machine** and how you can explore the web’s history, visit [https://web.archive.org/](https://web.archive.org/).
`;
